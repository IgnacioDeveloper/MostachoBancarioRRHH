		...
		ajax_request.onreadystatechange=function(){
			if(ajax_request.readyState == 4 && ajax_request.status == 200){
				switch(operacion){
					...
					case "saveArea": callContext.confirmacion(ajax_request.responseText,1);break;
					case "modifyArea":callContext.confirmacion(ajax_request.responseText,2);break;
					case "deleteArea":callContext.updateAreas(ajax_request.responseText);break; 
					case "getArea":callContext.setFormData(ajax_request.responseText);break;
